...
Usage:
  python experiments/mse/mse_cond.py \
...
def compute_mse_cond(infer_dir: Path, clip_stats_path: Path) -> pd.DataFrame:
    """
    infer_dir:       directory with infer_gaussian.py outputs
                     (contains raw/*.json, raw/*_gen_error.raw, raw/img/*_clean.raw)
